...
def load_data():
    data = pd.read_csv("https://raw.githubusercontent.com/Larasitradini/ADDP/25c7fa3f1fe66abc141d3064efdeeda71f73d84f/hour.csv")
    return data
...
st.sidebar.markdown("**• Nama: Laras Itra Dini**")
